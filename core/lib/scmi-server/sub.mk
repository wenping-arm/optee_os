...
# embedded modules.
# The SCP-firmware modules to be build is specify in a make
# file located in SCP-firmware directory.
...
scpfw-cmake-flags-y = -DSCP_FIRMWARE_SOURCE_DIR:PATH=optee/$(scpfw-product)/fw \
...
depends-fwk_module_list = $(scpfw-path)/product/optee/$(scpfw-product)/fw/Firmware.cmake $(conf-file)
...
include $(scpfw-path)/product/optee/common/sub-optee-scmi.mk
